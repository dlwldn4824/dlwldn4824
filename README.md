...
| 2026.06.26 | [지능형 로봇 컨소시엄 대상](https://github.com/dlwldn4824/smart_icheon_care) | [이천스마트 케어](https://lnkd.in/p/gf6RXq2X) |
...
- **KT 희망나눔 랜선나눔캠퍼스 멘토링** — 중학생에게 AI·데이터를 같이 만들어 보게 하는 중
- **교내 AI 티키타카 멘토** — 전기/전자과 학생들에게 AI 프로젝트를 알려주고 함께 진행 중
- **교내 이산수학 멘토 · 튜터** — 그 외 여러 멘토링 진행
